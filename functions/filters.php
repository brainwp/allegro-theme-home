...
function OT_fields($fields) {
	$fields['author'] = '<p class="contact-form-user"><label for="c_name">'.__("Nome",THEME_NAME).'<span class="required">*</span></label><input type="text" placeholder="'.__("Nickname..",THEME_NAME).'" name="author" id="author"></p>';
	...
	$fields['url'] = '<p class="contact-form-webside"><label for="c_webside">'.__("Website",THEME_NAME).'</label><input type="text" placeholder="'.__("Website..",THEME_NAME).'" name="url" id="url"></p>';
...
function OT_fields_rules($fields) {
	$fields['rules'] = '<p>'.__("Seu endereço de e-mail nãoserá publicado.", THEME_NAME).'<br/>'.__("Campos obrigatórios estão marcados com", THEME_NAME).'<span class="required">*</span></p>';
	print $fields['rules'];
}
