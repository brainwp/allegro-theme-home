	...
	<?php echo $before_widget; ?>
		<?php if($title) echo $before_title.$title.$after_title; ?>
			...
			<div class="mailing-list">
				...
				<div class="info-message success aweber-success" style="display:none;">
					<span class="icon-text">&#128077;</span>
					<b><?php _e("Success!", THEME_NAME);?></b>
					<p><?php _e("Everything went well, You are now subscribed !", THEME_NAME);?></p>
				</div>

				<div class="info-message fail aweber-fail" style="display:none;">
					<span class="icon-text">&#9888;</span>
					<b><?php _e("Error Occurred!", THEME_NAME);?></b>
					<p></p>
				</div>

				<div class="info-message aweber-loading" style="display:none;">
					<span class="icon-text">&#10227;</span>
					<b><?php _e("Loading!", THEME_NAME);?></b>
